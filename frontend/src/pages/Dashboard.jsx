...
const Dashboard = () => {
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <div className="mb-4">
        <button onClick={() => setActiveTab('available')} className={`mr-2 p-2 ${activeTab === 'available' ? 'bg-blue-500 text-white' : 'bg-gray-200'}`}>Available Auctions</button>
        <button onClick={() => setActiveTab('my')} className={`mr-2 p-2 ${activeTab === 'my' ? 'bg-blue-500 text-white' : 'bg-gray-200'}`}>My Auctions</button>
        <button onClick={() => setActiveTab('history')} className={`p-2 ${activeTab === 'history' ? 'bg-blue-500 text-white' : 'bg-gray-200'}`}>Auction History</button>
      </div>
      {activeTab === 'available' && (
